...
# Tipos de imóvel (usando caixas de seleção)
    ...
    #um pra muitos
    proprietario = models.ForeignKey(proprietarios.models.Proprietario, verbose_name='Proprietário', help_text='Nome do Proprietário', on_delete=models.PROTECT, related_name='proprietario', default='')
